...
public abstract class RouteStrategy {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) { // L: 7487
			...
			var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOCU, Client.packetWriter.isaacCipher); // L: 8208
			var8.packetBuffer.writeShortAdd(WorldMapEvent.selectedItemId); // L: 8209
			var8.packetBuffer.writeShortAdd(class41.baseY + var1); // L: 8210
			var8.packetBuffer.writeShortAdd(ChatChannel.selectedItemSlot); // L: 8211
			var8.packetBuffer.writeShortAddLE(var0 + NetFileRequest.baseX); // L: 8212
			var8.packetBuffer.writeInt(WorldMapLabelSize.selectedItemWidget); // L: 8213
			var8.packetBuffer.writeShort(var3); // L: 8214
			var8.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8215
			...
			var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOCT, Client.packetWriter.isaacCipher); // L: 8226
			var8.packetBuffer.writeShortLE(var0 + NetFileRequest.baseX); // L: 8227
			...
			var8.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8231
			...
			var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOC1, Client.packetWriter.isaacCipher); // L: 7974
			var8.packetBuffer.writeShortAddLE(var0 + NetFileRequest.baseX); // L: 7975
			...
			var8.packetBuffer.writeShortAddLE(var3); // L: 7978
			...
			var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOC2, Client.packetWriter.isaacCipher); // L: 7925
			var8.packetBuffer.writeShort(var3); // L: 7926
			var8.packetBuffer.writeShortLE(var0 + NetFileRequest.baseX); // L: 7927
			var8.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7928
			var8.packetBuffer.writeShortAdd(class41.baseY + var1); // L: 7929
			...
			var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOC3, Client.packetWriter.isaacCipher); // L: 7667
			var8.packetBuffer.writeShortAddLE(class41.baseY + var1); // L: 7668
			var8.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7669
			var8.packetBuffer.writeShortLE(var3); // L: 7670
			var8.packetBuffer.writeShortAdd(var0 + NetFileRequest.baseX); // L: 7671
			...
			var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOC4, Client.packetWriter.isaacCipher); // L: 8193
			var8.packetBuffer.writeShortAdd(class41.baseY + var1); // L: 8194
			var8.packetBuffer.writeShortAdd(var3); // L: 8195
			var8.packetBuffer.writeShortAdd(var0 + NetFileRequest.baseX); // L: 8196
			var8.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8197
			...
			if (var2 == 7) {
				...
				if (var13 != null) { // L: 7851
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPCU, Client.packetWriter.isaacCipher); // L: 7859
					var9.packetBuffer.writeIntIME(WorldMapLabelSize.selectedItemWidget); // L: 7860
					var9.packetBuffer.writeShortAddLE(var3); // L: 7861
					var9.packetBuffer.writeShortLE(ChatChannel.selectedItemSlot); // L: 7862
					var9.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7863
				...
				if (var13 != null) { // L: 7950
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPCT, Client.packetWriter.isaacCipher); // L: 7958
					var9.packetBuffer.writeShortLE(var3); // L: 7959
					var9.packetBuffer.writeShortAddLE(Client.selectedSpellChildIndex); // L: 7960
					var9.packetBuffer.writeIntLE(MouseHandler.selectedSpellWidget); // L: 7961
					var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7962
				...
				if (var13 != null) { // L: 8171
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC1, Client.packetWriter.isaacCipher); // L: 8179
					var9.packetBuffer.writeShortAdd(var3); // L: 8180
					var9.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8181
				...
				if (var13 != null) { // L: 7756
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC2, Client.packetWriter.isaacCipher); // L: 7764
					var9.packetBuffer.writeShortAddLE(var3); // L: 7765
					var9.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7766
				...
				if (var13 != null) { // L: 7983
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC3, Client.packetWriter.isaacCipher); // L: 7991
					var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7992
				...
				if (var13 != null) { // L: 7835
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC4, Client.packetWriter.isaacCipher); // L: 7843
					var9.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7844
					var9.packetBuffer.writeShortAdd(var3); // L: 7845
				...
				if (var13 != null) { // L: 8254
					...
					var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC5, Client.packetWriter.isaacCipher); // L: 8262
					var9.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8263
					var9.packetBuffer.writeShortLE(var3); // L: 8264
				...
				if (var2 == 14) {
					...
					if (var15 != null) { // L: 7642
						...
						var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYERU, Client.packetWriter.isaacCipher); // L: 7650
						var9.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7651
						var9.packetBuffer.writeIntIME(WorldMapLabelSize.selectedItemWidget); // L: 7652
						var9.packetBuffer.writeShortAddLE(ChatChannel.selectedItemSlot); // L: 7653
						var9.packetBuffer.writeShortLE(var3); // L: 7654
					...
					if (var15 != null) { // L: 8123
						...
						var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYERT, Client.packetWriter.isaacCipher); // L: 8131
						var9.packetBuffer.writeShort(var3); // L: 8132
						var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8133
						var9.packetBuffer.writeShortLE(Client.selectedSpellChildIndex); // L: 8134
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJU, Client.packetWriter.isaacCipher); // L: 7682
					var8.packetBuffer.writeIntLE(WorldMapLabelSize.selectedItemWidget); // L: 7683
					var8.packetBuffer.writeShortAddLE(var0 + NetFileRequest.baseX); // L: 7684
					var8.packetBuffer.writeShortLE(WorldMapEvent.selectedItemId); // L: 7685
					var8.packetBuffer.writeShortLE(class41.baseY + var1); // L: 7686
					var8.packetBuffer.writeShortAdd(ChatChannel.selectedItemSlot); // L: 7687
					var8.packetBuffer.writeShortAddLE(var3); // L: 7688
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJT, Client.packetWriter.isaacCipher); // L: 8243
					var8.packetBuffer.writeShortAddLE(class41.baseY + var1); // L: 8244
					var8.packetBuffer.writeShortAddLE(var0 + NetFileRequest.baseX); // L: 8245
					var8.packetBuffer.writeShortAddLE(Client.selectedSpellChildIndex); // L: 8246
					var8.packetBuffer.writeShortAdd(var3); // L: 8247
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8248
					var8.packetBuffer.writeIntIME(MouseHandler.selectedSpellWidget); // L: 8249
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJ1, Client.packetWriter.isaacCipher); // L: 7820
					...
					var8.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7824
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJ2, Client.packetWriter.isaacCipher); // L: 8021
					var8.packetBuffer.writeShort(class41.baseY + var1); // L: 8022
					var8.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8023
					var8.packetBuffer.writeShortLE(var3); // L: 8024
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJ3, Client.packetWriter.isaacCipher); // L: 8092
					var8.packetBuffer.writeShortAdd(class41.baseY + var1); // L: 8093
					var8.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8094
					var8.packetBuffer.writeShortAdd(var0 + NetFileRequest.baseX); // L: 8095
					var8.packetBuffer.writeShortLE(var3); // L: 8096
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJ4, Client.packetWriter.isaacCipher); // L: 7594
					var8.packetBuffer.writeShort(var0 + NetFileRequest.baseX); // L: 7595
					var8.packetBuffer.writeShortAdd(var3); // L: 7596
					var8.packetBuffer.writeShortAddLE(class41.baseY + var1); // L: 7597
					...
					var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJ5, Client.packetWriter.isaacCipher); // L: 7620
					var8.packetBuffer.writeShort(var3); // L: 7621
					var8.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7622
					var8.packetBuffer.writeShort(class41.baseY + var1); // L: 7623
					var8.packetBuffer.writeShortAddLE(var0 + NetFileRequest.baseX); // L: 7624
					...
					if (var2 == 24) {
						...
						if (var11) { // L: 7777
							var12 = ItemContainer.getPacketBufferNode(ClientPacket.UNKNOWN_6, Client.packetWriter.isaacCipher); // L: 7779
						...
						if (var2 == 26) {
							...
							Widget var14;
							if (var2 == 28) {
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.UNKNOWN_6, Client.packetWriter.isaacCipher); // L: 7530
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.UNKNOWN_6, Client.packetWriter.isaacCipher); // L: 7716
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELDU, Client.packetWriter.isaacCipher); // L: 8030
								...
								var8.packetBuffer.writeIntIME(WorldMapLabelSize.selectedItemWidget); // L: 8034
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELDT, Client.packetWriter.isaacCipher); // L: 7629
								var8.packetBuffer.writeShort(var3); // L: 7630
								var8.packetBuffer.writeShort(var0); // L: 7631
								var8.packetBuffer.writeShortAdd(Client.selectedSpellChildIndex); // L: 7632
								var8.packetBuffer.writeIntIME(MouseHandler.selectedSpellWidget); // L: 7633
								var8.packetBuffer.writeIntLE(var1); // L: 7634
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELD1, Client.packetWriter.isaacCipher); // L: 7730
								var8.packetBuffer.writeShort(var0); // L: 7731
								var8.packetBuffer.writeIntLE(var1); // L: 7732
								var8.packetBuffer.writeShortAdd(var3); // L: 7733
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELD2, Client.packetWriter.isaacCipher); // L: 7705
								var8.packetBuffer.writeShort(var0); // L: 7706
								var8.packetBuffer.writeShortLE(var3); // L: 7707
								var8.packetBuffer.writeIntLE(var1); // L: 7708
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELD3, Client.packetWriter.isaacCipher); // L: 7519
								var8.packetBuffer.writeShortLE(var0); // L: 7520
								var8.packetBuffer.writeShortAdd(var3); // L: 7521
								var8.packetBuffer.writeIntLE(var1); // L: 7522
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELD4, Client.packetWriter.isaacCipher); // L: 8112
								var8.packetBuffer.writeShortAddLE(var0); // L: 8113
								var8.packetBuffer.writeIntIME(var1); // L: 8114
								...
								var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPHELD5, Client.packetWriter.isaacCipher); // L: 8141
								var8.packetBuffer.writeIntME(var1); // L: 8142
								var8.packetBuffer.writeShortLE(var0); // L: 8143
								...
								if (var2 == 39) {
									var8 = ItemContainer.getPacketBufferNode(ClientPacket.IF1_BUTTON1, Client.packetWriter.isaacCipher); // L: 8160
									var8.packetBuffer.writeShortAdd(var3); // L: 8161
									var8.packetBuffer.writeIntME(var1); // L: 8162
									var8.packetBuffer.writeShortAdd(var0); // L: 8163
									...
									var8 = ItemContainer.getPacketBufferNode(ClientPacket.IF1_BUTTON2, Client.packetWriter.isaacCipher); // L: 7603
									var8.packetBuffer.writeShort(var3); // L: 7604
									var8.packetBuffer.writeShortLE(var0); // L: 7605
									...
									var8 = ItemContainer.getPacketBufferNode(ClientPacket.IF1_BUTTON3, Client.packetWriter.isaacCipher); // L: 8270
									var8.packetBuffer.writeShortAdd(var3); // L: 8271
									var8.packetBuffer.writeInt(var1); // L: 8272
									var8.packetBuffer.writeShortLE(var0); // L: 8273
									...
									var8 = ItemContainer.getPacketBufferNode(ClientPacket.IF1_BUTTON4, Client.packetWriter.isaacCipher); // L: 8101
									var8.packetBuffer.writeShortAddLE(var0); // L: 8102
									var8.packetBuffer.writeShortAddLE(var3); // L: 8103
									var8.packetBuffer.writeIntLE(var1); // L: 8104
									...
									var8 = ItemContainer.getPacketBufferNode(ClientPacket.IF1_BUTTON5, Client.packetWriter.isaacCipher); // L: 7694
									var8.packetBuffer.writeShortAddLE(var3); // L: 7695
									var8.packetBuffer.writeShortAddLE(var0); // L: 7696
									var8.packetBuffer.writeIntIME(var1); // L: 7697
									...
									if (var15 != null) { // L: 8070
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER1, Client.packetWriter.isaacCipher); // L: 8078
										var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8079
										var9.packetBuffer.writeShortAddLE(var3); // L: 8080
									...
									if (var15 != null) { // L: 7552
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER2, Client.packetWriter.isaacCipher); // L: 7560
										var9.packetBuffer.writeShortAddLE(var3); // L: 7561
										var9.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7562
									...
									if (var15 != null) { // L: 7798
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER3, Client.packetWriter.isaacCipher); // L: 7806
										var9.packetBuffer.writeShort(var3); // L: 7807
										var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7808
									...
									if (var15 != null) { // L: 7887
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER4, Client.packetWriter.isaacCipher); // L: 7895
										var9.packetBuffer.writeShortAddLE(var3); // L: 7896
										var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7897
									...
									if (var15 != null) { // L: 7903
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER5, Client.packetWriter.isaacCipher); // L: 7911
										var9.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7912
										var9.packetBuffer.writeShortAdd(var3); // L: 7913
									...
									if (var15 != null) { // L: 7999
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER6, Client.packetWriter.isaacCipher); // L: 8007
										var9.packetBuffer.writeByteAdd(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8008
										var9.packetBuffer.writeShortAdd(var3); // L: 8009
									...
									if (var15 != null) { // L: 8044
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER7, Client.packetWriter.isaacCipher); // L: 8052
										var9.packetBuffer.writeShortAdd(var3); // L: 8053
										var9.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8054
									...
									if (var15 != null) { // L: 7934
										...
										var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPPLAYER8, Client.packetWriter.isaacCipher); // L: 7942
										var9.packetBuffer.writeByteSub(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7943
									...
									if (var2 == 58) {
										...
										if (var16 != null) { // L: 7505
											var9 = ItemContainer.getPacketBufferNode(ClientPacket.IF_BUTTONT, Client.packetWriter.isaacCipher); // L: 7507
											var9.packetBuffer.writeInt(MouseHandler.selectedSpellWidget); // L: 7508
											var9.packetBuffer.writeShort(var0); // L: 7509
											var9.packetBuffer.writeShortAdd(Client.field836); // L: 7510
											var9.packetBuffer.writeShortAddLE(Client.selectedSpellChildIndex); // L: 7511
											var9.packetBuffer.writeShortLE(var16.itemId); // L: 7512
											var9.packetBuffer.writeIntME(var1); // L: 7513
										...
										var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOC5, Client.packetWriter.isaacCipher); // L: 7747
										var8.packetBuffer.writeByteNeg(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7748
										var8.packetBuffer.writeShortLE(class41.baseY + var1); // L: 7749
										var8.packetBuffer.writeShortLE(var0 + NetFileRequest.baseX); // L: 7750
										...
										var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPLOC6, Client.packetWriter.isaacCipher); // L: 8064
										var8.packetBuffer.writeShortLE(var3); // L: 8065
										...
										if (var13 != null) { // L: 7874
											...
											if (var17 != null) { // L: 7877
												var12 = ItemContainer.getPacketBufferNode(ClientPacket.OPOBJ6, Client.packetWriter.isaacCipher); // L: 7879
												var12.packetBuffer.writeShortLE(var17.id); // L: 7880
										...
										var8 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC6, Client.packetWriter.isaacCipher); // L: 7546
										var8.packetBuffer.writeShortAdd(var3); // L: 7547
										...
										if (var16 != null && var16.itemQuantities[var0] >= 100000) { // L: 7568
											...
											var9 = ItemContainer.getPacketBufferNode(ClientPacket.OPNPC6, Client.packetWriter.isaacCipher); // L: 7571
											var9.packetBuffer.writeShortAdd(var3); // L: 7572
